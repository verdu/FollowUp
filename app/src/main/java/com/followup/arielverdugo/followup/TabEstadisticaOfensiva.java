...
public class TabEstadisticaOfensiva extends android.support.v4.app.Fragment implements EstadisticaOfensivaAdapter.ItemClickListener{
    ...
    protected EstadisticaOfensivaAdapter mAdapter;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        View rootView = inflater.inflate(R.layout.tab_estadisticas_ofensivas, container, false);
        Context c = rootView.getContext();
        rootView.setTag(TAG);

        mRecyclerView = (RecyclerView) rootView.findViewById(R.id.recyclerOfensivas);
        ...
        mAdapter = new EstadisticaOfensivaAdapter(c,mDataset);
