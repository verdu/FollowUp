...
public class TabEstadisticaDefensiva extends android.support.v4.app.Fragment implements EstadisticaDefensivaAdapter.ItemClickListener{
    ...
    protected EstadisticaDefensivaAdapter mAdapter;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        View rootView = inflater.inflate(R.layout.tab_estadisticas_defensivas, container, false);
        Context c = rootView.getContext();
        rootView.setTag(TAG);

        mRecyclerView = (RecyclerView) rootView.findViewById(R.id.recyclerDefensivas);
        ...
        mAdapter = new EstadisticaDefensivaAdapter(c,mDataset);
