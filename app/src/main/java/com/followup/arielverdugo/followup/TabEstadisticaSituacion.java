...
public class TabEstadisticaSituacion extends android.support.v4.app.Fragment implements EstadisticaSituacionAdapter.ItemClickListener{
    ...
    protected EstadisticaSituacionAdapter mAdapter;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        View rootView = inflater.inflate(R.layout.tab_estadisticas_situaciones, container, false);
        Context c = rootView.getContext();
        rootView.setTag(TAG);

        mRecyclerView = (RecyclerView) rootView.findViewById(R.id.recyclerSituaciones);
        ...
        mAdapter = new EstadisticaSituacionAdapter(c,mDataset);
